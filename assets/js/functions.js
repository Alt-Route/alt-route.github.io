// accessibility scripts | Author: Todd Willsie [todd@willsie.net], 2021 | Licence: GPL V3 */
function resizeText(multiplier) {
	...
	var allleads = document.getElementsByClassName("lead");
	for (var i = 0; i < allleads.length; i++) {
		var lead = allleads[i];
		if (lead.style.fontSize == "") {
			lead.style.fontSize = "1.25 em";
		}
		lead.style.fontSize = parseFloat(lead.style.fontSize) + (multiplier * 0.2)  + "rem";
	}
  }
